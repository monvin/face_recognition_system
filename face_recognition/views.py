...
def face_recognition(request):
	...
	request.session['uname'] = name_array
	request.session['distar'] = str(dist_array)
	request.session['idf'] = id_faces
	request.session['tf'] = no_faces
	request.session['unidf'] = no_faces-id_faces	
